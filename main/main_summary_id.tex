...
\includeonly{
    ...
    contents/chapter-2/chapter-2-sum-id,
    contents/chapter-3/chapter-3-sum-id,
    contents/chapter-4/chapter-4-sum-id,
    contents/chapter-5/chapter-5-sum-id
    }
%======================================
...
%---- COVER ---- 
\printcover{images/logougm.png}{Ringkasan Tesis}
...
\cleardoublepage \phantomsection
\include{contents/chapter-1/chapter-1-sum-id}
\cleardoublepage \phantomsection
\include{contents/chapter-2/chapter-2-sum-id}
\cleardoublepage \phantomsection
\include{contents/chapter-3/chapter-3-sum-id}
\cleardoublepage \phantomsection
\include{contents/chapter-4/chapter-4-sum-id}
\cleardoublepage \phantomsection
\include{contents/chapter-5/chapter-5-sum-id}
%======================================
